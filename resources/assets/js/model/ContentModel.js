...
class ContentModel extends BaseModel {
  ...
  async loadSource(page, size, search, cat_id) {
    ...
    return await http.get('/contents', params)
  }

  async get(id) {
    return await http.get(`/contents/${id}`)
  }

  async create(entity) {
    return await http.post('/contents', entity)
  }

  async update(entity) {
    await http.patch(`/contents/${entity.id}`, entity)
  }

  async remove(entity) {
    await http.delete(`/contents/${entity.id}`)
  }
